...
class ZhihuSpider(RedisCrawlSpider):
    ...
    phone = '+8617826801382'  # 手机号
    password = 'yqq950206..'  # 密码
    ...
    redis_key = 'redis_zhihu:start_urls'
    rules = (
        Rule(LinkExtractor(allow='zhihu/.com[\w\S]+/.html'), callback='parse_job', follow=True),
    )
    ...
    def login(self, response):
        ...
        fp = open('F:\data_all\ArticleSpider-ArticleSpider-elasticsearch\ArticleSpider\spiders\zhihu.js')
        js = fp.read()
        fp.close()
