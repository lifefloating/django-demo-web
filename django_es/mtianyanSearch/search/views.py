...
from .models import ArticleType, ZhiHuQuestionType, LagouType
...
class IndexView(View):
    ...
    def get(self, request):
        ...
        topn_search = redis_cli.zrevrangebyscore(
            "search_keywords_set", "+inf", "-inf", start=0, num=5) # inf 最大分 最小分 从大到小排序
